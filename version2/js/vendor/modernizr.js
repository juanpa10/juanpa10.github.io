...
This repository
Search
 Watch 967  Star 18,568  Fork 2,584 Modernizr/Modernizr
 Code  Issues 96  Pull requests 26  Wiki  Pulse  Graphs
Branch: master Find file Copy pathModernizr/bin/modernizr
6a9c4e1  16 days ago
@patrickkettner patrickkettner allow for setClasses to be included via cli flag (#2043)
6 contributors @patrickkettner @SlexAxton @peterblazejewicz @jorrit @jon301 @pdot86
RawBlameHistory     Executable File  185 lines (164 sloc)  4.45 KB
#!/usr/bin/env node
'use strict';
